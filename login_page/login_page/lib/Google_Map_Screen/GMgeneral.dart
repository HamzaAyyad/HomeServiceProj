...
class GoogleMapsGeneral extends StatefulWidget {
  @override
  _MyGoogleMapsGeneral createState() => _MyGoogleMapsGeneral();
}

class _MyGoogleMapsGeneral extends State<GoogleMapsGeneral> {
  @override
  void initState() {
    super.initState();
    getlocation();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Request General Maintenance'),
