...
class GoogleMapsElec extends StatefulWidget {
  @override
  _MyGoogleMapselec createState() => _MyGoogleMapselec();
}

class _MyGoogleMapselec extends State<GoogleMapsElec> {
  @override
  void initState() {
    super.initState();
    getlocation();
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text( 'Electrical',style: TextStyle(
