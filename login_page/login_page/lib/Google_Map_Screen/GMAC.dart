...
class GoogleMapsAC extends StatefulWidget {
  @override
  _MyGoogleMapsAC createState() => _MyGoogleMapsAC();
}

class _MyGoogleMapsAC extends State<GoogleMapsAC> {
  @override
  void initState() {
    super.initState();
    getlocation();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Request AC Maintenance'),
      ),
      body: Stack(
        children: [
          GoogleMap(
