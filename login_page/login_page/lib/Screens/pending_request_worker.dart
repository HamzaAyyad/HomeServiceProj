...
class RequestWorker extends StatefulWidget {
  final String id;

  RequestWorker({this.id});

  @override
  _RequestWorkerState createState() => _RequestWorkerState();
}

class _RequestWorkerState extends State<RequestWorker> {
