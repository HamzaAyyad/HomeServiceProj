...
class OngoingtRequestCustomer extends StatefulWidget {
  final String id;
  OngoingtRequestCustomer({this.id});
  @override
  _OngoingRequestCustomerState createState() => _OngoingRequestCustomerState();
}

class _OngoingRequestCustomerState extends State<OngoingtRequestCustomer> {
  CustomerRequestInfo requestInfo=CustomerRequestInfo(wokerImage:'https://firebasestorage.googleapis.com/v0/b/home-services-283bc.appspot.com/o/images%2FUsers%2Fmohammadnassar%2FLibrary%2FDeveloper%2FCoreSimulator%2FDevices%2F82E35996-AB79-45C7-AF14-86024F407A99%2Fdata%2FContainers%2FData%2FApplication%2F4A9AC857-E5C5-4A25-A18C-E6FFEA298EA3%2Ftmp%2Fcom.mhmdnsar.loginPage-Inbox%2FprofilePic.png?alt=media&token=5601c0ca-05f0-47c3-bf09-6336be5ecc54',
      ...
      description: '',phoneNumber: '',workerName: '' );
  @override
  void initState() {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: [
                      GestureDetector(
                          child: buildCard(title: requestInfo.phoneNumber, icon: Icons.phone),
                        onTap: (){
